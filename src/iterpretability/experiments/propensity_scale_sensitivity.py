...
class PropensityScaleSensitivity(ExperimentBase):
    """
    ...
    def __init__(
        ...
        self.propensity_alpha = cfg.propensity_alpha
    ...
    def run(self) -> None:
        ...
        if self.simulation_type == "TY":
            sim = TYSimulator(dim_X = self.X.shape[1], **self.cfg.simulator)
        elif self.simulation_type == "T":
            sim = TSimulator(dim_X = self.X.shape[1], **self.cfg.simulator)
            ...
            for propensity_type in self.propensity_types:
                for propensity_scale in self.propensity_scales:
                    ...
                    if self.simulation_type == "TY":
                        ...
                        if propensity_type in ["none_pred_overlap", "none_prog_overlap"]:
                            continue
                    ...
                    sim.alpha = self.propensity_alpha
        ...
        self.save_results(metrics_df, save_df_only=True)

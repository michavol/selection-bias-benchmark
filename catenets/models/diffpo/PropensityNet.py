...
def load_data(dataset_name = 'acic', current_id='0', x_dim = None, data_path=None):
    ...
    if dataset_name == 'acic2018':
            dataset_path = data_path + "acic2018_norm_data/" + current_id + ".csv"
            # print('dataset_path', dataset_path)
